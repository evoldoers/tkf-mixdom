...
labelled-simulation ("oracle") chain count.  Diagnostic
\texttt{diag\_cumulant\_structural\_bias.py} sweeps $n_{\text{fams}}
...
(\texttt{diag\_adam\_convergence\_vs\_bias.py}) sweeps Adam inner
...
no factorised $q$, no cumulant.  We then call the same BDI M-step
(\texttt{m\_step\_tkf92}) used by SVI-VarAnc.
